...
class _MovixerApi implements MovixerApi {
  _MovixerApi(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  @override
  Future<GenresResponse> getAllGenres(String apiKey) async {
  ...
  Future<MoviesByGenresResponse> getAllMoviesByGenres(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<MoviesByGenresResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = MoviesByGenresResponse.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<PopularMoviesResponse> getAllPopularMovies(String apiKey) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'api_key': apiKey};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<ActorsResponse> getAllActors(String apiKey) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'api_key': apiKey};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<MovieTopRatedResponse> getAllMoviesTopRated(String apiKey) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'api_key': apiKey};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<MovieTopRatedResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<MovieVideoResponse> getMovieVideos(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<MovieVideoResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = MovieVideoResponse.fromJson(_result.data!);
    return value;
  }
